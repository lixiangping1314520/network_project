<template>
    ...
    <div class="cnode-container">
      <m-box style="margin-top: 15px">
        <el-radio-group v-model="currentTab">
          <el-radio-button v-for="tab in tabs"
                           :key="tab.tab"
                           :label="tab.tab">{{tab.label}}</el-radio-button>
        </el-radio-group>
      </m-box>
  ...
  <el-pagination
    ...
    <div class="footer"
         style="margin-top: 100px; height: 100px; background-color: #fff">
